...
<body>
    ...
    <div class="container mx-auto my-5">
        <h3 class="text-center">Add Class Preferences <?php echo $unitCode;?></h3>
</div>
...
TABLE;
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?submit=1&applicantID=<?php echo $applicantID;?>&edit=0" method="post">
            ...
            <button onclick="window.location.href='class_preferences_view.php?unitCode=<?php echo $unitCode;?>&applicantID=<?php echo $applicantID;?>' " class="btn btn-primary">Cancel</button>
            </div>
